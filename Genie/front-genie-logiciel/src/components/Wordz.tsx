    ...
    return (
        <div className="relative h-[100%] flex items-center">
            <div className="bannertxt text-4xl sm:text-[7em]">
                <label>
                    <span className="word text-white">Université &nbsp; de &nbsp; Fianarantsoa.</span>
                    <span className="word text-white">Bienvenue &nbsp; </span>
                    <span className="word text-white">Les &nbsp; elites &nbsp; de &nbsp; l'EMIT </span>
                    <span className="word text-white">EMI &nbsp; Student</span>
                </label>
            </div>
        </div>
    )
